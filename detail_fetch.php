...
<table border="1px" class="w3-table-all w3-text-black">
	...
	$q="SELECT mid,date,amount,reason,month FROM add_fund WHERE month='$month' UNION SELECT cheque,date,amount,dept,reason FROM transaction WHERE month='$month' ORDER BY `date` ASC;";
